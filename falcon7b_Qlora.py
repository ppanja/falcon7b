...
class ScriptArguments:
    ...
    dataset_name: Optional[str] = field(
        ...
        # default="datasets/alpaca/Cleaned_date.json", # locally stored finance-alpaca dataset
...
dataset = load_dataset(script_args.dataset_name, 
                       split="train"
                       ) # for dataset "timdettmers/openassistant-guanaco"
# dataset = load_dataset("json", 
#                         data_files=script_args.dataset_name, 
#                         split="train"
#                         ) # for dataset "finance-alpaca"

trainer = SFTTrainer(
    model=model,
    train_dataset=dataset,
    peft_config=peft_config,
    dataset_text_field="text", # for dataset "timdettmers/openassistant-guanaco"
    # dataset_text_field="output", # for dataset "finance-alpaca"
